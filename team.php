        ...
        <div class="team">
            <div class="container">
                <div class="section-header text-center">
                    <p>Our Team</p>
                    <h2>Bertemu dengan para Profesional Barber Kami</h2>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/Anggara 1.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Anggara Wiyasa</h2>
                                <p>Master Barber</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/Saraswati 1.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Saraswati Ageng</h2>
                                <p>Pakar Rambut</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/inggrid.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Inggrid Pameela</h2>
                                <p>Pakar Rambut</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/mega.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Mega Ayuningtyas</h2>
                                <p>Pakar Pewarnaan Rambut</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/reyhan 1.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Reyhan Dharma</h2>
                                <p>Pakar Pewarnaan Rambut</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/azalea.jpg" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Azalea Putri</h2>
                                <p>Master Barber</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="img/zidane 1.jpg"Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Zidane Arfa Seta</h2>
                                <p>Master Barber</p>
                            </div>
                        </div>
                    </div>
